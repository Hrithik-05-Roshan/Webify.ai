                    ...
                    >
                        <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden'>
                            ...
                            <div className='relative px-8 pt-14 pb-10 text-center'>
                                <h1 className='inline-block mb-4 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-white'>AI-powered website builder</h1>
                                <h2 className='text-3xl font-semibold leading-tight mb-6 space-x-2'>
                                    <span>Welcome to</span>
                                    <span className='bg-linear-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent'>Webify.ai</span>
                                </h2>
                                <motion.button
                                ...
                                <div className='flex items-center gap-4 my-10'>
                                    ...
                                    <span className='text text-zinc-600 tracking-wide'> Secure Login</span>
                                    <div className='h-px flex-1 bg-white/10' />
                                </div>
                                <p className='text-xs text-zinc-400 leading-relaxed'>
                                    By continuing, you agree to our{" "}
                                    <span className='underline cursor-pointer hover:text-zinc-300'>Terms of Service</span>{" "}and{" "}
