      ...
      <div className='sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10' >
        <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between' >
          <div className='flex items-center gap-2'>
            ...
            <h1 className='text-lg font-semibold'>Webify.<span className='text-zinc-400'>ai</span></h1>
          </div>
        </div>
      </div>
      <div className='max-w-6xl mx-auto px-6 py-16'>
        ...
        >
          ...
          <h1 className='text-4xl md:text-5xl font-bold mb-5 leading-tight'>Build Websites with
            <span className='block bg-linear-to-r from-white to-zinc-400 bg-clip-text text-transparent'>Real AI Power</span></h1>
          <p className='text-zinc-400 max-w-2xl mx-auto'>
            This process may take several minutes.
            Webify.ai focuses on quality, not shortcuts.
          </p>
        </motion.div>
        <div className='mb-14 '>
          ...
          <div>
            ...
            value={prompt}
            placeholder='Describe your webside in detail...'
